...
class LayoutCell(object):
    ...
    def render(self, context, cache_key_prefix=None):
        ...
        cache_namespace = "shuup_xtheme_cell"
        if getattr(plugin_inst, "cache_namespace", None):
            cache_namespace = plugin_inst.cache_namespace
        ...
        try:
            if plugin_inst.is_context_valid(context=context):
                ...
                full_cache_key = f"{cache_namespace}:{hash_key}"
