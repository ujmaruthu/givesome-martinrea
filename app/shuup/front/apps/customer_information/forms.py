...
from shuup.front.setting_keys import SHUUP_CUSTOMER_INFORMATION_ALLOW_PICTURE_UPLOAD
...
class PersonContactForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if configuration.get(None, SHUUP_CUSTOMER_INFORMATION_ALLOW_PICTURE_UPLOAD):
