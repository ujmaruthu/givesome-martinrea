...
class BaseAdminURLGetter(object):
    ordering = 0

    def get_model_admin_url(
        object,
        kind="detail",
        user=None,
        ...
        **kwargs,
        ...
        raise NotImplementedError("Error! Not implemented: `BaseAdminURLGetter` -> `get_model_url()`.")


class AdminURLGetter(BaseAdminURLGetter):
    # This one should go last since it can raise the NoModeUrl exception.
    ordering = 999
