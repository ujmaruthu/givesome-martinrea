...
class ShuupAdminAppConfig(AppConfig):
    ...
    provides = {
        ...
        "admin_module": [
            ...
            "shuup.admin.modules.smtp_accounts.SMTPAccountModule",
        ...
        "admin_model_url_getter": ["shuup.admin.utils.urls.AdminURLGetter"],
        ...
        "system_settings_form_part": [
            "shuup.admin.modules.settings.forms.system.InstallationSettingsFormPart",
        ...
        "admin_smtp_account_form_part": [
            "shuup.admin.modules.smtp_accounts.form_parts.SMTPAccountBaseFormPart",
            "shuup.admin.modules.smtp_accounts.form_parts.TestEmailFormPart",
        ],
        "product_list_mass_actions_provider": [
            "shuup.admin.modules.products.views.list.ProductListMassActionProvider",
        ],
    }
