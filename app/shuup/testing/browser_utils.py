...
def wait_until_disappeared(browser, css_selector, timeout=20, frequency=1.0):
    """
...
def wait_until_appeared(browser, css_selector, timeout=20, frequency=1.0):
    """
...
def wait_until_appeared_xpath(browser, xpath, timeout=20, frequency=1.0):
    wait_until_condition(
        browser,
...
def wait_until_condition(browser, condition, timeout=20, frequency=1.0):
    """
...
def click_element(browser, css_selector, timeout=20, frequency=1.0, header_height=155):
    """
