...
class Task:
    ...
    countdown = None  # Optional[int]

    def __init__(self, function, identifier=None, stored=False, queue="default", countdown=None, **kwargs):
        """
        ...
        :param countdown: An optional number of seconds to start executing the task.
            This option must be implemented by the task runner.
...
class TaskRunner:
    def create_task(
        self, function, stored=False, queue="default", task_identifier=None, countdown=None, **kwargs
    ) -> Task:
        """
