...
#: WARNING: DEPRECATED SETTINGS: WILL BE REMOVED ON NEXT MAJOR RELEASE
#: The following settings are now being loaded from system settings.
#:
...
#: Spec which provides the default PriceDisplayOptions used by the template tag `show_prices`.
SHUUP_DEFAULT_PRICE_DISPLAY_OPTIONS = "shuup.core.pricing.PriceDisplayOptions"
