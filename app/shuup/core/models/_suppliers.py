...
class Supplier(ModuleInterface, TranslatableShuupModel):
    ...
    translations = TranslatedFields(description=models.TextField(blank=True, verbose_name=_("image and video")),
                                    desc=models.TextField(blank=True, verbose_name=_("description")),
                                    content_header=models.TextField(blank=True, verbose_name=_("description header")),
                                    video_header=models.TextField(blank=True, verbose_name=_("video header")))
    ...
    def get_orderability_errors(self, shop_product, quantity, customer=None, *args, **kwargs):
        """
