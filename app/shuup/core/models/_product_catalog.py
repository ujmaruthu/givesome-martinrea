...
class ProductCatalogPriceRule(models.Model):
    ...
    authenticated_user = models.BooleanField(
        ...
        editable=False,
        null=True,
        help_text=_("Whether the product is available only for authenticated users."),
    )
...
class ProductCatalogPrice(MoneyPropped, models.Model):
    ...
    price_value = MoneyValueField(
        editable=False, verbose_name=_("price"), help_text=_("The indexed product price"), db_index=True
    )
    is_visible = models.BooleanField(
        ...
        editable=False,
        help_text=_(
            "Whether the product is visible. This status is managed by the pricing module. "
            "The visibility can be some product attribute that disables it or even a disabled shop or supplier."
        ),
    )
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["shop", "is_visible", "is_available"]),
        ]
