...
def index_shop_product_price(
    ...
    for discount in discounts:
        ...
        catalog_price = (
            ...
            .filter(
                Q(
                    ...
                    catalog_rule__contact_group=discount.contact_group,
                    catalog_rule__contact=discount.contact,
                ),
                Q(
        ...
        if discount.discount_amount_value is not None:
            discount_options.append(normal_price - discount.discount_amount_value)

        if discount.discount_percentage is not None:
            discount_options.append(normal_price - (normal_price * discount.discount_percentage))
