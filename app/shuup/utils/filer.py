...
def file_name_size_validator(value):
    file_name_size = len(value.name)

    if file_name_size > 150:
        msg = _("The file name with extension should be less than or equals to 150 characters. It has {} characters.")
        raise ValidationError(msg.format(file_name_size), code="file_name_too_big")
